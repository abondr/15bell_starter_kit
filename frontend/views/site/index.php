...
<section id="slider">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
        <img src="<?=Yii::$app->urlManager->createAbsoluteUrl("img/homebanner.jpg")?>" class="img-responsive" style="visibility: hidden;">
...
<section id="manycircle">
  <div class="container">
    <div class="row">
       ...
       <div class="col-md-12">
         <img src="<?=Yii::$app->urlManager->createAbsoluteUrl("img/aaa.jpg")?>" class="img-responsive">
       </div>
